...
// ============================================================
// ✅ ULTRA PREMIUM KPI GRID (Glow Azul B)
// Layout sofisticado, animação stagger e 10 cards prontos.
// ============================================================
...
export default function DashboardKPIGrid({ kpis }) {
  ...
  return (
    ...
    >
      ...
      {/* ============================================================
         ✅ SEGUNDO BLOCO — /performance-report
      ============================================================ */}
      ...
      {/* ============================================================
         ✅ TERCEIRO BLOCO — /cleaning-schedule
      ============================================================ */}
