...
export default function CleaningReminders() {
  ...
  const handlePeriodicSubmit = async (event) => {
    ...
    try {
      ...
      console.error("Erro ao salvar tarefa periódica:", err);
  ...
  const togglePeriodicTask = async (task) => {
    try {
      ...
      console.error("Erro ao alternar tarefa periódica:", err);
  ...
  const completePeriodicTask = async (event) => {
    ...
    try {
      ...
      console.error("Erro ao registrar conclusao periódica:", err);
      setError(err.message || "Erro ao registrar conclusao da tarefa periódica.");
    }
  };
  ...
  const removePeriodicTask = async (task) => {
    ...
    try {
      ...
      console.error("Erro ao remover tarefa periódica:", err);
  ...
  const removeSelectedPeriodicTasks = async () => {
    ...
    try {
      ...
      console.error("Erro ao remover tarefas periódicas em massa:", err);
          ...
          <form onSubmit={handlePeriodicSubmit} className="space-y-4">
            ...
            <div className="rounded-xl border border-slate-200 p-3 dark:border-slate-700">
              <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
                <div>
                  <div className="text-sm font-semibold">Acomodações</div>
            ...
            <textarea
              ...
              placeholder="Descrição ou instrucao"
